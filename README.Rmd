...
```{r, github rendering, eval = F, eval=FALSE, include = FALSE}
...
```{r Default sim phenotypique diversity, echo = F, eval = F}
...
```{r trait through time, echo = F, eval = F}
...
```{r fitness 2 traits, echo = F, eval = F}
...
```{r number of phenotypes, echo = F, eval = F}
